...
void FMfigure( )
{
 ...
 if( flags & PARA_NUM )                      /* if numbering the paragraphs */
  sprintf( obuf, "Figure %d-%d: ", pnum[0], fig );   /* gen fig number */
 else       /* dont include para number if not numbering paragraphs */
  sprintf( obuf, "Figure %d: ", fig );   /* gen fig number */

 fig++;                           /* increment the fig number */

 optr = strlen( obuf );    /* put stuff after figure lable */
